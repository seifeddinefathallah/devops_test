    ...
    stages {
      ...
      stage('Cleaning the project') {
       ...
       stage('Nexus'){
             steps{
                 echo "nexus"
                 sh'mvn clean package deploy:deploy-file -DgroupId=com.esprit.examen -DartifactId=tpachat -Dversion=1.0 -DgeneratePom=true -Dpackaging=jar -DrepositoryId=deploymentRepo -Durl=http://192.168.1.31:8081/repository/deploymentRepo/ -Dfile=target/tpachat-1.0.jar '
             }
         }
          stage(' Sonarqube') {
